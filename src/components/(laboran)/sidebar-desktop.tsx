      ...
      <div className='h-full px-3 py-4'>
        ...
        <div className='mt-5'>
          <div className={`flex flex-col gap-5 w-full pt-10 text-[#DEE4E8]`}>
            ...
            {/* <Link href="/dashboard-laboran">
              <SidebarButton
                variant={pathname === '/dashboard-laboran' ? 'secondary' : 'ghost'}
            ...
            <Link href="/prioritas-kebutuhan">
              <SidebarButton
                ...
                className='w-full text-md'
              >
                {isCollapsed ? null : 'Prioritas Kebutuhan'}
              </SidebarButton>
            </Link>
            <Link href="/ruangan">
              <SidebarButton
                ...
                <Button variant='ghost' className='w-full justify-start text-white'>
                  <div className='flex justify-between items-center w-full'>
                    <div className='flex gap-2 items-center'>
                      ...
                      <span className={`text-[#DEE4E8] text-[20px] whitespace-normal ${isCollapsed ? 'hidden' : 'block'}`}>{session?.user?.name ?? 'Unknown User'}</span>
                    </div>
