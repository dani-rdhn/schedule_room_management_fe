...
const DataTableRowActions = <TData extends DataWithId & Room,>({ table, column, row }: DataTableRowActionsProps<TData>) => {
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        mutate("http://localhost:5000/rooms");
      } else {
  ...
  // const onDelete = async () => {
  //   // Add your delete logic here if you need to update your data.
  ...
  return (
    <>
      ...
      <AlertDialogDelete
        ...
        mutate={() => mutate("http://localhost:5000/rooms")}
      />
      <DialogFormUpdate 
